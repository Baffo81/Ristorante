...
public class Waiter {
                ...
                while (true) {
                    ...
                    new Thread(() -> {
                        ...
                        while (true){
                            ...
                            try {
                                verifica = getOrder(acceptedCustomer, chefSocket);
                                if(verifica.equalsIgnoreCase("Cliente Andato")){
    ...
    // gets an order by the customer and sends it to the chef to prepare it
    public static String getOrder(Socket acceptedCustomer, Socket chefSocket) throws IOException {
